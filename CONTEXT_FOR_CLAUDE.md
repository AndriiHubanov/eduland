...
- **Зображення** для замків (20 варіантів), юнітів (6×3 рівні), руїн (3 тири) — є `docs/PHASE8_IMAGE_PROMPTS.md`
- **Ліміт досліджень одночасно** (Lab рів.1 → 1 дослідження, Рів.2 → 2, Рів.3 → 3)
- **Кооперативні місії** — групові цілі для всієї групи
- **PvP** — гравець проти гравця через WorldMap
- **Сезонна таблиця лідерів** — реcет рейтингу кожен сезон
- **Admin-панель** для перегляду бойових логів, армій гравців
- **Нотифікації** — push або in-app для виконаних місій / завершених досліджень
