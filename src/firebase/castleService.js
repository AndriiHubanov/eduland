...
export const CASTLE_UPGRADE_LORE = {
  guardian: {
    2: 'Стіни зміцнено. Твоя твердиня стає прихистком для більшої армії — остання лінія оборони Академії.',
    3: 'Фортеця Стражів піднімається. Ті, хто ховається у тіні руїн, починають бачити в тобі силу.',
    4: 'Цитадель Залізної Волі завершена. Жодна армія не прорветься крізь ці стіни.',
    5: 'Бастіон Останньої Лінії стоїть. Ця фортеця не впала ніколи — і не впаде.',
  },
  archivist: {
    2: 'Бібліотека Кодів відкрила другий поверх. Знання — найдорожчий ресурс після Колапсу.',
    3: 'Лабораторія Знань онлайн. Старі дані розшифровано — частину цивілізації можна відновити.',
    4: 'Сервер Абсолютної Пам\'яті запущено. Все, що людство втратило у 2039 — повертається.',
    5: 'Сховище Істини завершено. Єдине місце, де зберігаються знання до і після Колапсу.',
  },
  detective: {
    2: 'Слідчий центр відкрито. Руїни навколо говорять, якщо вміти слухати.',
    3: 'Обсерваторія Тіней. Твої агенти бачать загрози за 48 годин до удару.',
    4: 'Мережа Всевидячих активована. Жодного сліпого кута на карті.',
    5: 'Око Бурі завершено. Детектив, що збудував це, знає відповідь на питання Колапсу.',
  },
  coordinator: {
    2: 'Командний вузол активовано. Перші торгові шляхи між таборами відновлено.',
    3: 'Координаційна башта. Сигнал сягає всіх союзників — разом ви швидші й сильніші.',
    4: 'Нексус Зв\'язку запущено. Економіка нового світу тримається на твоїх протоколах.',
    5: 'Центр Глобального Контролю. Те, що ООН не змогла — ти зробив. Координація без кордонів.',
  },
}
...
export async function upgradeCastle(playerId) {
  await runTransaction(db, async (tx) => {
    ...
    if (getHeroLevel(player.xp || 0) < currentLevel) {
